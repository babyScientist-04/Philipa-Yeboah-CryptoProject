...
const SignUp = () => {
  ...
  const socialButtons = [
    { name: "Google", text: "Sign up with Google", icon: <FcGoogle size={20} /> },
    { name: "Apple",  text: "Sign up with Apple",  icon: <FaApple  size={20} /> },
  ];
    ...
    <div className="bg-black w-full min-h-screen text-white">
      ...
      <main className="px-6 flex flex-col items-center justify-center pt-10">
        <div className="w-full max-w-md">
          <h1 className="font-bold text-3xl text-gray-100">Create your account</h1>
          <p className="text-gray-400 font-extralight mt-1">
